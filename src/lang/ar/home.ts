...
export const homeAr: HomeTranslations = {
  meta: {
...
hero: {
  items: [
    {
      title: "خدمات الصرف الصحي الريفي المستدام.",
      subtitle: "رائدون في تطوير البنية التحتية البيئية في كافة أنحاء أقاليم مصر، لنقل المياه النظيفة وخدمات الصرف الصحي لملايين المواطنين عبر حلول هندسية متطورة."
    },
    {
      title: "هندسة ابتكارية من أجل المستقبل.",
      subtitle: "توفير المياه النظيفة وخدمات الصرف الصحي لأكثر من 5 ملايين مواطن."
    }
  ],
   primaryCta: "عرض تفاصيل المشروع",
  ...
  cta: {
    title: "لنحوّل رؤيتك إلى واقع.",
    subtitle:
      "تواصل مع خبرائنا لبدء مبادرتك القادمة في البنية التحتية أو التطوير.",
    button: "تواصل معنا",
  },
  footer: {
    sections: {
